...
export const SCHEMA: Record<string, string[]> = {
  ...
  stay_briefs: ["trip_id", "user_id", "ran_at", "brief", "area_text", "split_text", "price_year"],
  stay_candidates: ["id", "trip_id", "user_id", "place_id", "letter", "name", "address", "lat", "lng", "site", "url", "total", "currency", "nightly_cad", "beds", "baths", "sleeps", "pool", "ac", "score", "score_scale", "reviews", "review_notes", "fit_text", "flags", "drive", "status", "reject_reason", "source", "created_at", "google_place_id", "photos", "feel", "base"],
...
export const TRIP_CHILDREN: { table: string; column: string; onDelete: string }[] = [
  ...
  { table: "stay_briefs", column: "trip_id", onDelete: "CASCADE" },
