  ...
  return (
    <div className="relative w-full flex-shrink-0" style={{ height }}>
      <div
        ...
        className="flex h-full overflow-x-auto overflow-y-hidden overscroll-x-contain snap-x snap-mandatory [&::-webkit-scrollbar]:hidden"
      ...
      {attribution && (
        <div
          className="absolute bottom-2 left-2 z-10 max-w-[60%] truncate text-[9px] leading-none text-white/70 [&_a]:text-white/70 [&_a]:no-underline"
